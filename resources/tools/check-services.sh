...
/tools/wait-for-it.sh -q -t 500 nifi:8080     -- echo 'Apache NiFi   is ready!  http://127.0.0.1:8080/nifi or' http://$PUBLIC_IP:8080/nifi 
/tools/wait-for-it.sh -q -t 500 minio-s3:9000 -- echo 'Minio (S3)    is ready!  http://127.0.0.1:9000      or' http://$PUBLIC_IP:9000      
